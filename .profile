...
install_git_completion () {
    ...
    if grep -Fxq "unset prompts" ~/.bash_profile
    then 
      sed -i='' '/source ~\/.git-completion.bash/,/unset prompts/d' ~/.bash_profile
    fi

    cp .git-completion.bash ~/
    source ~/.git-completion.bash
    cp .git-colorization.bash ~/
    source ~/.git-colorization.bash

    if grep -Fq ".git-completion.bash" ~/.bash_profile
    then
    ...
    if grep -Fq ".git-colorization.bash" ~/.bash_profile
    then
      echo "Git Colorization already installed"
    else
      echo source ~/.git-colorization.bash >> ~/.bash_profile
    fi
}
...
install_make_completion () {
    cp .make-completion.bash ~/
    touch ~/.bash_profile
    if grep -Fq ".make-completion.bash" ~/.bash_profile
    then
      echo "Already installed"
    else
      echo source ~/.make-completion.bash >> ~/.bash_profile
